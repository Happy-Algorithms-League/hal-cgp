"""
Example for evolutionary regression using NumPy
===============================================

Example demonstrating the use of Cartesian genetic programming for
two regression tasks using NumPy to vectorized function evaluations.
"""
...
docopt_str = """
   Usage:
     example_evo_regression_numpy.py [--max-generations=<N>]
...
if __name__ == "__main__":
    ...
    fig.savefig("example_evo_regression_numpy.pdf")
