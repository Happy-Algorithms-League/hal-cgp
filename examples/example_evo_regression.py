...
if __name__ == '__main__':
    ...
    for i, (label, target_function) in enumerate(zip(['easy', 'hard'],
                                                     [f_target_easy, f_target_hard])):
        ...
        y_target = [target_function(np.stack((x0_range,
                                              np.ones_like(x0_range) * x1)).T)
                    for x1 in x1_range]
